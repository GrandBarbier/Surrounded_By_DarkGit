...
void MainLight_half(float3 WorldPos, out half3 Direction, out half3 Color, out half DistanceAtten, out half ShadowAtten)
{
    ...
    ShadowAtten = 1;
	    ...
	    half4 shadowCoord = ComputeScreen(clipPos);
	#else
        ...
        ShadowAtten = SampleShadowmap(shadowCoord, TEXTURE2D_SHADOW_ARGS(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), shadowSamplingData, shadowStrength, false);
    #endif  
#endif
}
