...
Shader "Vignette 2.0"
{
	Properties
	{
		...
		_VignetteScale("Vignette Scale", Range( 0 , 5)) = 0.5354622
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float simplePerlin2D8 = snoise( tex2D( _MainTex, appendResult23_g11 ).rg*_Scale1 );
				...
				float Alpha = ( SampleGradient( gradient15, ( simplePerlin2D8 * length( ( texCoord11 * _VignetteScale ) ) ) ) * _Alpha1 ).r;
...
/*ASEBEGIN
Version=18908
1913;36;1920;983;2819.768;399.9983;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-2106.926,434.2701;Float;False;Property;_VignetteScale;Vignette Scale;4;0;Create;False;0;0;0;False;0;False;0.5354622;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;18;-1930.404,-233.5688;Inherit;True;Property;_MainTex;MainTex;2;0;Create;False;0;0;0;False;0;False;-1;23a800b35bf17504e8665a5caa1bfb9b;23a800b35bf17504e8665a5caa1bfb9b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1725.274,-24.94447;Inherit;False;Property;_Scale1;Scale;5;0;Create;True;0;0;0;False;0;False;0;0.43;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-795.7491,325.3136;Inherit;False;Property;_Alpha1;Alpha;3;0;Create;True;0;0;0;False;0;False;1;0.866;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=19FFA6276DAA86CFD3AFA727D89227C2749DD979